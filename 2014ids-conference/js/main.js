jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2014, 11-1, 18)}); // enter event day  18-20 November 2014
...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 14,
        center: new google.maps.LatLng(-37.814386, 144.960440), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(-37.814386, 144.960440) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>IDEAS OF DIGITAL CONFERENCE (IDSC) 2014 </b><br/>Melbourne"  //add your address
    });
